...
if __name__ == '__main__':
    from View.Controls.CamImageWidget import CamImageWidget
    ...
    app = QApplication([])
    main = QMainWindow()
    image_control = CamImageWidget()
    main.setCentralWidget(image_control)

    im = ColorMapImage('viridis', width=200, height=100)
    image_control.set_image(im)
