from ViewModel.ToolViewModels.ColormapEditorViewModel import ColormapEditorViewModel
from QtModularUiPack.Widgets import EmptyFrame, PlotMasterWidget
...
from Model.Framework.ColorMapUtils import ColorMapImage
...
class ColormapEditorFrame(EmptyFrame):
    ...
    def __init__(self, parent=None, *args, **kwargs):
        ...
        self.data_context.property_changed.append(self._property_changed_)
