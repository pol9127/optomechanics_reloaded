...
from ViewModel.ToolViewModels.camera_frame_view_model import CameraFrameViewModel
...
from PyQt5.QtWidgets import QVBoxLayout, QGridLayout, QDialog, QPushButton, QLabel, QSlider, QMenuBar, QSpinBox
