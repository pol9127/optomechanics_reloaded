...
class Roboclaw(object):
    ...
    def ForwardM1(self, address, val):
        return self._write1(address, self.M1FORWARD, val)
    
    def BackwardM1(self, address, val):
        return self._write1(address, self.M1BACKWARD, val)
    
    def SetMinVoltageMainBattery(self, address, val):
        return self._write1(address, self.SETMINMB, val)
    
    def SetMaxVoltageMainBattery(self, address, val):
        return self._write1(address, self.SETMAXMB, val)
    
    def ForwardM2(self, address, val):
        return self._write1(address, self.M2FORWARD, val)
    
    def BackwardM2(self, address, val):
        return self._write1(address, self.M2BACKWARD, val)
    
    def ForwardBackwardM1(self, address, val):
        return self._write1(address, self.M17BIT, val)
    
    def ForwardBackwardM2(self, address, val):
        return self._write1(address, self.M27BIT, val)
    
    def ForwardMixed(self, address, val):
        return self._write1(address, self.MIXEDFORWARD, val)
    
    def BackwardMixed(self, address, val):
        return self._write1(address, self.MIXEDBACKWARD, val)
    
    def TurnRightMixed(self, address, val):
        return self._write1(address, self.MIXEDRIGHT, val)
    
    def TurnLeftMixed(self, address, val):
        return self._write1(address, self.MIXEDLEFT, val)
    
    def ForwardBackwardMixed(self, address, val):
        return self._write1(address, self.MIXEDFB, val)
    
    def LeftRightMixed(self, address, val):
        return self._write1(address, self.MIXEDLR, val)
    
    def ReadEncM1(self, address):
        return self._read4_1(address, self.GETM1ENC)
    
    def ReadEncM2(self, address):
        return self._read4_1(address, self.GETM2ENC)
    
    def ReadSpeedM1(self, address):
        return self._read4_1(address, self.GETM1SPEED)
    
    def ReadSpeedM2(self, address):
        return self._read4_1(address, self.GETM2SPEED)
    
    def ResetEncoders(self, address):
        return self._write0(address, self.RESETENC)
    
    def ReadVersion(self, address):
        tries = self._triestimeout
        while 1:
            self.ser.flushInput()
            self._sendcommand(address, self.GETVERSION)
            str = ""
            passed = True
            for i in range(0, 48):
                data = self.ser.read(1)
    ...
    def SetEncM1(self, address, cnt):
        return self._write4(address, self.SETM1ENCCOUNT, cnt)
    
    def SetEncM2(self, address, cnt):
        return self._write4(address, self.SETM2ENCCOUNT, cnt)
    
    def ReadMainBatteryVoltage(self, address):
        return self._read2(address, self.GETMBATT)
    
    def ReadLogicBatteryVoltage(self, address, ):
        return self._read2(address, self.GETLBATT)
    
    def SetMinVoltageLogicBattery(self, address, val):
        return self._write1(address, self.SETMINLB, val)
    
    def SetMaxVoltageLogicBattery(self, address, val):
        return self._write1(address, self.SETMAXLB, val)
    
    def SetM1VelocityPID(self, address, p, i, d, qpps):
        return self._write4444(address, self.SETM1PID, int(d*65536),
                               int(p*65536), int(i*65536), qpps)
    
    def SetM2VelocityPID(self, address, p, i, d, qpps):
        return self._write4444(address, self.SETM2PID, int(d*65536),
                               int(p*65536), int(i*65536), qpps)
    
    def ReadISpeedM1(self, address):
        return self._read4_1(address, self.GETM1ISPEED)
    
    def ReadISpeedM2(self, address):
        return self._read4_1(address, self.GETM2ISPEED)
    
    def DutyM1(self, address, val):
        return self._writeS2(address, self.M1DUTY, val)
    
    def DutyM2(self, address, val):
        return self._writeS2(address, self.M2DUTY, val)
    
    def DutyM1M2(self, address, m1, m2):
        return self._writeS2S2(address, self.MIXEDDUTY, m1, m2)
    
    def SpeedM1(self, address, val):
        return self._writeS4(address, self.M1SPEED, val)
    
    def SpeedM2(self, address, val):
        return self._writeS4(address, self.M2SPEED, val)
    
    def SpeedM1M2(self, address, m1, m2):
        return self._writeS4S4(address, self.MIXEDSPEED, m1, m2)
    
    def SpeedAccelM1(self, address, accel, speed):
        return self._write4S4(address, self.M1SPEEDACCEL, accel, speed)
    
    def SpeedAccelM2(self, address, accel, speed):
        return self._write4S4(address, self.M2SPEEDACCEL, accel, speed)
    
    def SpeedAccelM1M2(self, address, accel, speed1, speed2):
        return self._write4S4S4(address, self.M1SPEEDACCEL, accel, speed1, 
                                speed2)
    
    def SpeedDistanceM1(self, address, speed, distance, buffer):
        return self._writeS441(address, self.M1SPEEDDIST, speed, distance, 
                               buffer)
    
    def SpeedDistanceM2(self, address, speed, distance, buffer):
        return self._writeS441(address, self.M2SPEEDDIST, speed, distance, 
                               buffer)
    
    def SpeedDistanceM1M2(self, address, speed1, distance1, speed2, distance2, 
                          buffer):
        return self._writeS44S441(address, self.MIXEDSPEEDDIST, speed1, 
                                  distance1, speed2, distance2, buffer)
    
    def SpeedAccelDistanceM1(self, address, accel, speed, distance, buffer):
        return self._write4S441(address, self.M1SPEEDACCELDIST, accel, speed, 
                                distance, buffer)
    
    def SpeedAccelDistanceM2(self, address, accel, speed, distance, buffer):
        return self._write4S441(address, self.M2SPEEDACCELDIST, accel, speed, 
                                distance, buffer)
    
    def SpeedAccelDistanceM1M2(self, address, accel, speed1, distance1, speed2, 
                               distance2, buffer):
        return self._write4S44S441(address, self.MIXEDSPEED2ACCELDIST, accel, 
                                   speed1, distance1, speed2, distance2, 
                                   buffer)
    
    def ReadBuffers(self, address):
        val = self._read2(address, self.GETBUFFERS)
        if val[0]:
            return (1, val[1] >> 8, val[1] & 0xFF)
        return (0, 0, 0)
    
    def ReadPWMs(self, address):
        val = self._read4(address, self.GETPWMS)
        if val[0]:
            pwm1 = val[1] >> 16
            pwm2 = val[1] & 0xFFFF
            if pwm1 & 0x8000:
    ...
    def ReadCurrents(self, address):
        val = self._read4(address, self.GETCURRENTS)
        if val[0]:
            cur1 = val[1] >> 16
            cur2 = val[1] & 0xFFFF
            if cur1 & 0x8000:
    ...
    def SpeedAccelM1M2_2(self, address, accel1, speed1, accel2, speed2):
        return self._write4S44S4(address, self.MIXEDSPEED2ACCEL, accel1, 
                                 speed1, accel2, speed2)
    
    def SpeedAccelDistanceM1M2_2(self, address, accel1, speed1, distance1, 
                                 accel2, speed2, distance2, buffer):
        return self._write4S444S441(address, self.MIXEDSPEED2ACCELDIST, accel1, 
                                    speed1, distance1, accel2, speed2, 
                                    distance2, buffer)
    
    def DutyAccelM1(self, address, accel, duty):
        return self._writeS24(address, self.M1DUTYACCEL, duty, accel)
    
    def DutyAccelM2(self, address, accel, duty):
        return self._writeS24(address, self.M2DUTYACCEL, duty, accel)
    
    def DutyAccelM1M2(self, address, accel1, duty1, accel2, duty2):
        return self._writeS24S24(address, self.MIXEDDUTYACCEL, duty1, accel1, 
                                 duty2, accel2)
        
    def ReadM1VelocityPID(self, address):
        data = self._read_n(address, self.READM1PID, 4)
        if data[0]:
            data[1] /= 65536.0
            data[2] /= 65536.0
            data[3] /= 65536.0
    ...
    def ReadM2VelocityPID(self, address):
        data = self._read_n(address, self.READM2PID, 4)
        if data[0]:
            data[1] /= 65536.0
            data[2] /= 65536.0
            data[3] /= 65536.0
    ...
    def SetMainVoltages(self, address, min,  max):
        return self._write22(address, self.SETMAINVOLTAGES, min, max)
        
    def SetLogicVoltages(self, address, min,  max):
        return self._write22(address, self.SETLOGICVOLTAGES, min, max)
        
    def ReadMinMaxMainVoltages(self, address):
        val = self._read4(address, self.GETMINMAXMAINVOLTAGES)
        if val[0]:
            min = val[1] >> 16
            max = val[1] & 0xFFFF
            return (1, min, max)
    ...
    def ReadMinMaxLogicVoltages(self, address):
        val = self._read4(address, self.GETMINMAXLOGICVOLTAGES)
        if val[0]:
            min = val[1] >> 16
            max = val[1] & 0xFFFF
            return (1, min, max)
    ...
    def SetM1PositionPID(self, address, kp, ki, kd, kimax, deadzone, min, max):
        return self._write4444444(address, self.SETM1POSPID, int(kd*1024),
                                  int(kp*1024), int(ki*1024), kimax,
                                  deadzone, min, max)
    
    def SetM2PositionPID(self, address, kp, ki, kd, kimax, deadzone, min, max):
        return self._write4444444(address, self.SETM2POSPID, int(kd*1024),
                                  int(kp*1024), int(ki*1024), kimax,
                                  deadzone, min, max)
    
    def ReadM1PositionPID(self, address):
        data = self._read_n(address, self.READM1POSPID, 7)
        if data[0]:
            data[0] /= 1024.0
            data[1] /= 1024.0
            data[2] /= 1024.0
    ...
    def ReadM2PositionPID(self, address):
        data = self._read_n(address, self.READM2POSPID, 7)
        if data[0]:
            data[0] /= 1024.0
            data[1] /= 1024.0
            data[2] /= 1024.0
    ...
    def SetDeadBand(self, address, min, max):
        return self._write11(address, self.SETDEADBAND, min, max)
    
    def GetDeadBand(self, address):
        val = self._read2(address, self.GETDEADBAND)
        if val[0]:
            return (1, val[1] >> 8, val[1] & 0xFF)
        return (0, 0, 0)
    ...
    def RestoreDefaults(self, address):
        return self._write0(address, self.RESTOREDEFAULTS)
    
    def ReadTemp(self, address):
        return self._read2(address, self.GETTEMP)
    
    def ReadTemp2(self, address):
        return self._read2(address, self.GETTEMP2)
    
    def ReadError(self, address):
        return self._read2(address, self.GETERROR)
    
    def ReadEncoderModes(self, address):
        val = self._read2(address, self.GETENCODERMODE)
        if val[0]:
            return (1, val[1] >> 8, val[1] & 0xFF)
        return (0, 0, 0)
        
    def SetM1EncoderMode(self, address, mode):
        return self._write1(address, self.SETM1ENCODERMODE, mode)
    
    def SetM2EncoderMode(self, address, mode):
        return self._write1(address, self.SETM2ENCODERMODE, mode)
    
    # saves active settings to NVM
    def WriteNVM(self, address):
        return self._write4(address, self.WRITENVM, 0xE22EAB7A)
    
    # restores settings from NVM
    # Warning(TTL Serial): If baudrate changes or the control mode changes 
    # communications will be lost
    def ReadNVM(self, address):
        return self._write0(address, self.READNVM)
    ...
    def SetConfig(self, address, config):
        return self._write2(address, self.SETCONFIG, config)
    
    def GetConfig(self, address):
        return self._read2(address, self.GETCONFIG)
    
    def SetM1MaxCurrent(self, address, max):
        return self._write44(address, self.SETM1MAXCURRENT, max, 0)
    
    def SetM2MaxCurrent(self, address, max):
        return self._write44(address, self.SETM2MAXCURRENT, max, 0)
    
    def ReadM1MaxCurrent(self, address):
        data = self._read_n(address, self.GETM1MAXCURRENT, 2)
        if data[0]:
            return (1, data[1])
        return (0, 0)
    
    def ReadM2MaxCurrent(self, address):
        data = self._read_n(address, self.GETM2MAXCURRENT, 2)
        if data[0]:
            return (1, data[1])
        return (0, 0)
    
    def SetPWMMode(self, address, mode):
        return self._write1(address, self.SETPWMMODE, mode)
    
    def ReadPWMMode(self, address):
        return self._read1(address, self.GETPWMMODE)
    
    ser = None
    
    def Open(self, comport, rate):
        self.ser = serial.Serial(comport, baudrate=rate, timeout=0.1)
